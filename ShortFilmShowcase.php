	...
	function myfunction(transactionId) {
		...
		if (person==true) {
			...
			fetch('api.php', {
				...
				body: JSON.stringify({
					"cancellationDate": "2020-01-10T18:44:01.034020",
					"partnerAPIKey": "Z97WIyTCtKEOI5XiTC5RBYjt7MdlEvtl",
...
<div class="btns">
	...
	if(isset($_SESSION['email']))
	{?>
	<center style=" float: right; margin-top: -112px !important ;margin-right: 20px;"><a class="btn btn-danger" href="logout.php">Logout</a></center>	
	<?php
	}
	$currentUser = $_SESSION['email'];
	{?>
	<center style=" float: right;margin-top: -112px !important ;margin-right: 100px;">
	<a class="btn btn-primary" href="register.php?email=<?php echo $currentUser; ?>">Settings</a></center>	
	<?php
	}
	?> 
